...
void testStdListComparison()
{
	...
	// push_back simulates stack push (LIFO)
	lst.push_back(5);
	lst.push_back(17);
	std::cout << "back after pushing 5, 17: " << lst.back() << std::endl;
	std::cout << "Size after 2 pushes: " << lst.size() << std::endl;

	// pop_back simulates stack pop
	lst.pop_back();
	std::cout << "Size after pop: " << lst.size() << std::endl;
	std::cout << "back after pop: " << lst.back() << std::endl;
	...
	std::cout << "Final back: " << lst.back() << std::endl;
	...
	std::cout << "Original list back: " << original.back() << std::endl;

	std::list<int> copy(original);
	std::cout << "Copy list size: " << copy.size() << std::endl;
	std::cout << "Copy list back: " << copy.back() << std::endl;
	...
	std::cout << "Before assignment:" << std::endl;
	std::cout << "List1 size: " << list1.size() << ", back: " << list1.back() << std::endl;
	std::cout << "List2 size: " << list2.size() << ", back: " << list2.back() << std::endl;
